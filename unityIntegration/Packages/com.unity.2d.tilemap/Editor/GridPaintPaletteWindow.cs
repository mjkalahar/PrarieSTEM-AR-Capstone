...
namespace UnityEditor.Tilemaps
{
    internal class GridPaintPaletteWindow : EditorWindow
    {
        ...
        private static class Styles
        {
            ...
            public static readonly GUIContent gizmos = EditorGUIUtility.TrTextContent("Gizmos");
            public static readonly GUIContent lockZPosition = EditorGUIUtility.TrTextContent("Lock Z Position");
        ...
        public void ResetPreviewInstance()
        {
            ...
            if (palette != null)
            {
                ...
                PrefabUtility.UnpackPrefabInstance(m_PaletteInstance, PrefabUnpackMode.Completely, InteractionMode.AutomatedAction);
